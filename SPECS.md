...
## Что нужно сделать \ Описание поведения
...
Детальное описание внешнего вида платформы и UI вы найдёте на макете в Figma.
...
Подробную документацию по работе с API вы найдёте на сайте
